...
class MeshletGeneration
{
  ...
  public:
    ...
    static std::vector<Meshlet> MeshletizeUnoptimizedTest(uint32_t maxVerts, uint32_t maxIndices, const std::vector<uint32_t> indices, const uint32_t verticesCount);
};
